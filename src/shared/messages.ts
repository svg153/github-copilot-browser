...
export type BackgroundMessage =
  ...
  | { type: 'SETTINGS_LOADED'; payload: Record<string, unknown> };
...
export type ContentScriptMessage =
  ...
  | { type: 'EXECUTE_JAVASCRIPT'; payload: { code: string; allowed?: boolean } }
...
export type NativeMessage =
  ...
  | { type: 'HOST_STATUS'; payload: { connected: boolean; error?: string; status?: string } }
